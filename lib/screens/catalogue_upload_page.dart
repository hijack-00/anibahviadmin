        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  SizedBox(width: 8),
                  Text('Generate EAN13 Barcode', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.indigo)),
                ],
              ),
            ),
            SizedBox(height: 8),
            ...
            ElevatedButton.icon(
              ...
              label: Text('Generate Barcode', style: TextStyle(color: Colors.white)),
              style: ElevatedButton.styleFrom(backgroundColor: Colors.indigo),
              onPressed: () {
                if (manualBarcode.length == 13 && int.tryParse(manualBarcode) != null) {
                  setState(() {
                    generatedBarcode = manualBarcode;
                  });
                } else {
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(content: Text('Please enter a valid 13-digit EAN13 number.')),
                  );
                }
              },
            ),
            SizedBox(height: 8),
            if (generatedBarcode.length == 13 && int.tryParse(generatedBarcode) != null)
              Card(
                elevation: 2,
                ...
                child: Padding(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('EAN13 Barcode:', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.indigo)),
                      SizedBox(height: 8),
                      Center(
                        child: SizedBox(
                          height: 80,
